...
<html lang="en">
	<head>
		<meta charset="UTF-8" />
		<title>Persona C: Marcela Díaz: Advocacy Organization</title>
	</head>
	<body>
		<main>
			<strong>Name:</strong> Marcela Díaz<br>
			...
			<strong>Goals:</strong> Maricela hopes that showmethemoney.com will be a useful tool for both herself, staff and volunteers. The ability to share the graphs on social media would also help with the effectiveness of her campaigns. She would also like the option for people to connect with their city officials after seeing this data.<br>
