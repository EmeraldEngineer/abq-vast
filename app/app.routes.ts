...
export const allAppComponents = [HomeComponent, AboutComponent, ShareComponent, MainNavComponent, GraphComponent, NotFoundComponent, LineComponent, BarComponent, CheckbookComponent];
